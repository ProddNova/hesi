...
function classifyGarageChild(garage, object) {
  ...
  // The runtime PSXStyle showroom car is attached to carDisplay at play time; it is
  // empty in the editor, so keep it out of the pick/edit set instead of letting
  // it look like a stray editable "Garage block".
  if (object === garage.carDisplay) return { layer: 'Props', type: 'garage-parked-car', label: 'Showroom car anchor', editable: false, selectable: false, note: 'PSXStyle car attached by the game at runtime; nothing to edit here' };
