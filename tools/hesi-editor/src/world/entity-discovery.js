...
const MATERIAL_CLASS = Object.freeze({
  ...
  facadeTownHouse: ['Buildings', 'building-batch', 'Town houses'],
  facadeRetail: ['Buildings', 'building-batch', 'Roadside retail'],
  facadeTenement: ['Buildings', 'building-batch', 'Tenement blocks'],
  facadeWorksOffice: ['Buildings', 'building-batch', 'Works offices'],
  facadeWorks: ['Buildings', 'building-batch', 'Machine works'],
  facadeColdStore: ['Buildings', 'building-batch', 'Cold stores'],
