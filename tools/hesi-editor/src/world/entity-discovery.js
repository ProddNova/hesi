...
const MATERIAL_CLASS = Object.freeze({
  ...
  facadeOffice: ['Buildings', 'building-batch', 'Office buildings'],
  facadeDark: ['Buildings', 'building-batch', 'Dark city buildings'],
  facadeHotel: ['Buildings', 'building-batch', 'Hotel buildings'],
  facadeIndustrial: ['Buildings', 'building-batch', 'Industrial buildings'],
  building: ['Buildings', 'building-roof-batch', 'Building roofs'],
  shed: ['Buildings', 'industrial-building-batch', 'Industrial sheds'],
