/**
 * Fixed cameras on the Wangan -> ramp 30 diverge (P4,
 * `J38:diverge:wangan_0:ramp_30:start`) — the inverse of the Tatsumi merge.
 *
 ...
 *
 * Run: node .devtests/ramp30-diverge-shots.mjs [suffix] [--legacy]
 * Writes .devtests/shots/RD-<case>[-suffix].png
 */
...
const cases = [
  { name: 'plan-widening', at: 3080, up: 150, back: 30, pitch: -1.2 },
  { name: 'plan-full-five', at: 3230, up: 150, back: 30, pitch: -1.2 },
  { name: 'plan-gore', at: 3300, up: 130, back: 30, pitch: -1.2 },
  { name: 'before-chase', at: 2975, up: 6, back: 26, pitch: -0.06 },
  { name: 'first-opening-chase', at: 3040, up: 6, back: 26, pitch: -0.06 },
  { name: 'four-lane-chase', at: 3100, up: 6, back: 26, pitch: -0.06 },
  { name: 'second-opening-chase', at: 3175, up: 6, back: 26, pitch: -0.06 },
  { name: 'five-lane-chase', at: 3245, up: 6, back: 26, pitch: -0.06 },
  { name: 'gore-chase', at: 3300, up: 6, back: 26, pitch: -0.06 },
  // Driver's eye in the exiting lanes themselves.
  { name: 'aux0-eye', at: 3120, up: 1.7, back: 24, pitch: -0.03, lateral: -7.1 },
  { name: 'exit-lane-eye', at: 3250, up: 1.7, back: 24, pitch: -0.03, lateral: -10.6 },
];
...
for (const c of cases) {
  ...
  await page.screenshot({ path: join(OUT, `RD-${c.name}${SUFFIX}.png`) });
  console.log(`shot RD-${c.name}${SUFFIX}.png`);
}
await browser.close();
server.close();
